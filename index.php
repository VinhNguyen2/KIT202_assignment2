                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                ...
                                <button onclick="load_page('Manager_page.php')">Admin Dashboard</button>
                            </td>
                           
                            <td>
                                <!--button Logout-->
                                <!--click event to load logout page by javascript-->
                                <button onclick="load_page('logout.php')">Log out</button>
                            </td>
