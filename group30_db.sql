...
INSERT INTO House (House_ID, Name, address, city, price, max, num_room, num_bathroom, available, garage, image, smocking,internet) VALUES (
 'House2', '78 Queenstreet Mall,', 'Hobart 7000', '550', 8, 4, 2, now(), 4, 'img/house2.jpg', 0, 0);

 INSERT INTO House (House_ID, Name, address, city, price, max, num_room, num_bathroom, available, garage, image, smocking,internet) VALUES (
 'House1', '114 Elizabeth St', 'Launceston 7250', '450', 6, 3, 2, now(), 3, 'img/house1.jpg', 0, 0);
...
INSERT INTO Cusmoter (customer_ID, first_name, last_name, email, phone, password, address, city, ABN) VALUES (
'Danh', 'Tran', 'dang.tran@utas.edu.au', '0495339300', '', '01 york street, launceston 7250', 234
);
INSERT INTO Cusmoter (customer_ID, first_name, last_name, email, phone, password, address, city, ABN) VALUES (
'Thong', 'Dang', 'thong.dang@utas.edu.au', '0495339311', '', '03 haha street, Hobart 7050', ''
);
INSERT INTO Cusmoter (customer_ID, first_name, last_name, email, phone, password, address, city, ABN) VALUES (
'Vinh', 'Nguyen', 'vinh.nguyen@utas.edu.au', '0495339322', '', '02 hehehe street, launceston 7250', 665
);
